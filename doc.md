[![Build status](https://ci.appveyor.com/api/projects/status/pw2xb491cujwb55o?svg=true)](https://ci.appveyor.com/project/Ekaterina-Isabel/4-card-delivery-order)
...
[![](pic/dropdown.png)](https://github.com/netology-code/aqa-homeworks/blob/master/selenide/pic/dropdown.png)

2. Выбор даты на неделю вперёд (начиная от текущей даты) через инструмент календаря:

![image](https://user-images.githubusercontent.com/79922872/172034898-ec467dfa-0736-407c-a8ff-bfee9b75a307.png)
